...
// Phase 25: every user is on the Free plan — no backend state consulted.
    ...
    <div className="relative min-h-full">
      ...
      <div className="relative z-10 max-w-2xl mx-auto py-6 px-4 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-heading text-2xl font-bold text-foreground">Billing & Plans</h1>
            <p className="text-sm text-muted-foreground">Manage your subscription</p>
          </div>
        </div>

        {/* Current plan card */}
        <GlowCard className="bg-card/80 backdrop-blur-xl p-5 space-y-4">
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h2 className="font-heading text-xl font-bold text-foreground">{CURRENT_PLAN.name}</h2>
              </div>
            </div>
        ...
        <GlowCard className="bg-card/80 backdrop-blur-xl p-5 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-heading text-base font-bold text-foreground">Unlock more with a paid plan</h2>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link
              href="/pricing"
              className="flex-1 inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-sm font-semibold bg-primary text-primary-foreground hover:bg-primary/90 transition-colors"
            >
            ...
            <button
              ...
              className="flex-1 py-2.5 px-4 rounded-xl text-sm font-semibold border border-border text-foreground hover:bg-muted transition-colors"
            >
              Start free trial
            </button>
          </div>
        ...
        {/* Payment not yet available notice */}
        <GlowCard className="bg-card/80 backdrop-blur-xl p-4">
